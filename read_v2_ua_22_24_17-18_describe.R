# read_v2_ua_22_24_17-18_describe.R
# ============================================================
...
input_file <- file.path(project_dir, 
        "read_v2_umgc_ua_22_24_combined_qa_outputs","read_v2_umgc_ua_22_24.rds")
...
read_v2_umgc_ua_22_24 <- readRDS(input_file)

# Final cleaned dataset:
# remove the rows of students older than 18
read_v2_umgc_ua_22_24_17_18 <- 
  read_v2_umgc_ua_22_24[read_v2_umgc_ua_22_24$age == 17 |  
                          read_v2_umgc_ua_22_24$age == 18,]

# remove the rows of 25 umgc students
read_v2_ua_22_24_17_18 <- 
  read_v2_umgc_ua_22_24_17_18[read_v2_umgc_ua_22_24_17_18$college == "ua2" |  
                            read_v2_umgc_ua_22_24_17_18$college == "ua23" ,]

# Quick QA checks
stopifnot(sum(duplicated(read_v2_ua_22_24_17_18$global_id)) == 0)

n_input <- nrow(read_v2_ua_22_24_17_18)

cat("Input raw rows:   ", n_input, "\n")

read_v2_ua_22_24_17_18 <- read_v2_ua_22_24_17_18 %>%
  mutate(
...
num_descriptives <- read_v2_ua_22_24_17_18 %>%
  summarise(
...
p_transfer_hist <- ggplot(read_v2_ua_22_24_17_18, aes(x = transfer)) +
  geom_histogram(bins = 30) +
  labs(title = "Transferred Credits Distribution", x = "Transferred Credits", y = "Count") +
  theme_minimal()

p_readTime_hist <- ggplot(read_v2_ua_22_24_17_18, aes(x = readTime)) +
  geom_histogram(bins = 30) +
  labs(title = "Read Time Distribution", x = "Read Time", y = "Count") +
  theme_minimal()

p_transfer_box <- ggplot(read_v2_ua_22_24_17_18, aes(y = transfer)) +
  geom_boxplot() +
  labs(title = "Boxplot of Transferred Credits", y = "Transferred Credits") +
  theme_minimal()

p_readTime_box <- ggplot(read_v2_ua_22_24_17_18, aes(y = readTime)) +
  geom_boxplot() +
...
save_both(read_v2_ua_22_24_17_18, output_dir, "read_v2_ua_22_24_17_18")

write.csv(
  cat_descriptives_df,
  file.path(output_dir, "categorical_descriptives_read_v2_ua_22_24_17_18.csv"),
  row.names = FALSE
)

write.csv(
  num_descriptives,
  file.path(output_dir, "numeric_descriptives_read_v2_ua_22_24_17_18.csv"),
  row.names = FALSE
)
